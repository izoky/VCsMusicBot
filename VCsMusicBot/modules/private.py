...
@Client.on_message(filters.command(["start","start@C125C"]) & ~filters.private & ~filters.channel)
...
@Client.on_message(filters.command(["help","@C125C"]) & ~filters.private & ~filters.channel)
